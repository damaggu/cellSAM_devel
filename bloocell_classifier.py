...
if __name__ == "__main__":
    ...
    # Load the datasets
    train_dataset = CustomImageDataset(csv_file=train_csv_file, img_dir=train_img_dir, transform=transform)
    val_dataset = CustomImageDataset(csv_file=val_csv_file, img_dir=val_img_dir, transform=transform)
